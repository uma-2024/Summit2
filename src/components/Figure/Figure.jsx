...
const Figure = () => {
  return (
    <div className="mt-20">
      ...
      <div className="grid p-5 md:grid-cols-4 gap-4 mt-5 px-8">
        <div className="box-figure min-h-[150px] flex flex-col items-center justify-center">
          <h2
        ...
        <div className="box-figure1 min-h-[150px] flex flex-col items-center justify-center">
          <h2
            style={{ fontFamily: "fontbold" }}
            className="figure-heading-g text-4xl"
          >
      ...
      <div className="mt-10">
        ...
        <div className="grid p-5 grid-cols-1 gap-1 mt-2 md:max-w-xl mx-auto checkdiv">
          ...
          <a
            ...
            href="https://linktr.ee/summitofficial"
            target="_blank"
            className="bg-blur-500 flex items-center mx-auto text-white px-4 py-2 rounded-lg hover:text-[#516aff] border border-[#516aff]"
          >
            <img
